...
#	puts "Finished"
#	if ((whois_list - dns_list).length != 0) && ((dns_list - whois_list).length != 0)
#		puts "descrepencies found between whois record and dns query for #{domain_name}"
#	end 

	#	whois_ns_list.each { |x| p x }
	#	p dns_list
